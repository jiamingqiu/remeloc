...
RcppExport SEXP _remeloc_geodesic(SEXP lon1SEXP, SEXP lat1SEXP, SEXP azi1SEXP, SEXP s12SEXP, SEXP aSEXP, SEXP fSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _remeloc_inversegeodesic(SEXP lon1SEXP, SEXP lat1SEXP, SEXP lon2SEXP, SEXP lat2SEXP, SEXP aSEXP, SEXP fSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<double> >::type lon1(lon1SEXP);
...
RcppExport SEXP _remeloc_polygonarea(SEXP lonSEXP, SEXP latSEXP, SEXP aSEXP, SEXP fSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _remeloc_geodesic_nodes(SEXP lon1SEXP, SEXP lat1SEXP, SEXP lon2SEXP, SEXP lat2SEXP, SEXP nSEXP, SEXP distanceSEXP, SEXP arcSEXP, SEXP aSEXP, SEXP fSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _remeloc_osgb(SEXP xSEXP, SEXP ySEXP, SEXP pSEXP, SEXP geoSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _remeloc_osgb_rev(SEXP gSEXP, SEXP precSEXP, SEXP centerpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_remeloc_geodesic", (DL_FUNC) &_remeloc_geodesic, 6},
    {"_remeloc_inversegeodesic", (DL_FUNC) &_remeloc_inversegeodesic, 6},
    {"_remeloc_polygonarea", (DL_FUNC) &_remeloc_polygonarea, 4},
    {"_remeloc_geodesic_nodes", (DL_FUNC) &_remeloc_geodesic_nodes, 9},
    {"_remeloc_osgb", (DL_FUNC) &_remeloc_osgb, 4},
    {"_remeloc_osgb_rev", (DL_FUNC) &_remeloc_osgb_rev, 3},
